        ...
        <div className="flex flex-col items-center justify-center p-8 lg:p-12 bg-white">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center space-y-2">
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-black">Welcome back</h1>
              <p className="text-gray-600 text-base md:text-lg">Login to your Employee Leaderboard account</p>
            </div>
